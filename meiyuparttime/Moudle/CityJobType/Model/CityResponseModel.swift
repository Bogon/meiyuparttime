...
struct CityJobTypeVosResponseModel: Mappable {
    ...
    var jobTypeVosList: [JobTypeVosInfoModel]? {
        ...
        let _job_type_vos_list: [JobTypeVosInfoModel] = [JobTypeVosInfoModel].init(JSONArray: _jobTypeVos)
    ...
    var systemPopularCitiesList: [CityInfoModel]? {
        ...
        let _system_popular_cities_list: [CityInfoModel] = [CityInfoModel].init(JSONArray: _systemPopularCities)
