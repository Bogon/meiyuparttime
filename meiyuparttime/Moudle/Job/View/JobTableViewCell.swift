...
class JobTableViewCell: UITableViewCell, NibReusable {
    ...
    @IBOutlet weak var info_content_view: UIView!
    @IBOutlet weak var nickname_label: UILabel!
    @IBOutlet weak var id_label: UILabel!
    @IBOutlet weak var job_want_label: UILabel!
    @IBOutlet weak var job_want_value_label: UILabel!
    @IBOutlet weak var job_base_title_label: UILabel!
    @IBOutlet weak var job_base_value_label: UILabel!
    @IBOutlet weak var job_xinzi_title_label: UILabel!
    @IBOutlet weak var job_xinzi_value_label: UILabel!
    @IBOutlet weak var job_advan_title_label: UILabel!
    @IBOutlet weak var job_advan_value_label: UILabel!
