...
class JobTypeContentView: UIView {
    ...
    @IBOutlet weak var recomand_button: UIButton!
    @IBOutlet weak var newest_button: UIButton!
    ...
    override func layoutSubviews() {
        ...
        for (index, type_info) in _type_data.enumerated() {
            ...
            /// 计算左边距
            let _type_button: UIButton = UIButton(frame: CGRect(x: _left_margin, y: _top_margin, width: _button_size.width, height: _button_size.height))
