...
class SignUpContentView: UIView {
    ...
    @IBOutlet var sc_title_label: UILabel!

    @IBOutlet var sc_nickname_content_view: UIView!
    @IBOutlet var sc_nickname_textFiled: JVFloatLabeledTextField!
    @IBOutlet var sc_n_validate_imagview: UIImageView!

    @IBOutlet var sc_email_content_view: UIView!
    @IBOutlet var sc_email_textFiled: JVFloatLabeledTextField!
    @IBOutlet var sc_e_validate_imagview: UIImageView!

    @IBOutlet var sc_password_content_view: UIView!
    @IBOutlet var sc_password_textFiled: JVFloatLabeledTextField!
    @IBOutlet var sc_p_validate_imagview: UIImageView!

    @IBOutlet var sc_login_buttton: UIButton!
    @IBOutlet var sc_signup_button: UIButton!
