...
class SettingHeaderView: UIView {
    ...
    @IBOutlet var setting_head_avatar_imageview: UIImageView!
    @IBOutlet var setting_nickname_label: UILabel!
    @IBOutlet var setting_h_login_button: UIButton!
    @IBOutlet var setting_h_title_label: UILabel!
    ...
    @IBAction func loginSignUpAction(_: UIButton) {
