...
class ExpectVosView: UIView {
    ...
    @IBOutlet weak var vos_imageview: UIImageView!
    @IBOutlet weak var title_label: UILabel!
    @IBOutlet weak var job_type_label: UILabel!
    @IBOutlet weak var salory_label: UILabel!
    @IBOutlet weak var address_label: UILabel!
    @IBOutlet weak var vos_label: UILabel!
