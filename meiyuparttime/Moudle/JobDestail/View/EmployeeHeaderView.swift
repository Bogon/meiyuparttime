...
class EmployeeHeaderView: UIView {
    ...
    @IBOutlet var user_content_view: UIView!
    @IBOutlet var nickname_label: UILabel!
    @IBOutlet var id_label: UILabel!
    @IBOutlet var job_status_view: UIView!
    @IBOutlet var job_status_label: UILabel!
    @IBOutlet var addr_status_view: UIView!
    @IBOutlet var addr_label: UILabel!
    @IBOutlet var age_label: UILabel!
    @IBOutlet var degree_label: UILabel!
    @IBOutlet var job_time_label: UILabel!
