...
class BottomBarView: UIView {
    ...
    @IBOutlet weak var notice_imageview: UIImageView!
    @IBOutlet weak var title_label: UILabel!
    @IBOutlet weak var phone_label: UILabel!
    @IBOutlet weak var warnning_imageview: UIImageView!
    ...
    override func awakeFromNib() {
        ...
        /// 添加左右晃动效果
        let shake: CABasicAnimation = CABasicAnimation(keyPath: "transform.translation.x")
    ...
    @IBAction func connected_action(_ sender: UIButton) {
