...
class JobTypeVosController: UIViewController {
    ...
    /// 标题
    var jobTypeVosNavigationView = JobTypeVosNavigationView.instance()!

    /// 城市列表
    var jobCityPanelView = JobCityPanelView.instance()!

    /// 工作类型列表
    var jobTypeVosPanelView = JobTypeVosPanelView.instance()!
