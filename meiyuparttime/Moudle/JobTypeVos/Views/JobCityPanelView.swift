...
class JobCityPanelView: UIView {
    ...
    @IBOutlet weak var jcp_title_label: UILabel!
    @IBOutlet weak var jcp_location_button: UIButton!
    
    @IBOutlet weak var jcp_hot_city_label: UILabel!
    ...
    override func layoutSubviews() {
        ...
        for (index, city_model) in _popular_cities_list.enumerated() {
            let city_button: UIButton = UIButton()
