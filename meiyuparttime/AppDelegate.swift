...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_: UIApplication, willFinishLaunchingWithOptions _: [UIApplication.LaunchOptionsKey: Any]? = nil) -> Bool {
        ...
        _ = query.get("5f1ff9c7943da80006f1a45c") { [weak self] result in
            switch result {
            case let .success(object: todo):
...
extension AppDelegate: JPUSHRegisterDelegate {
    ...
    func jpushNotificationCenter(_: UNUserNotificationCenter!, didReceive response: UNNotificationResponse!, withCompletionHandler _: (() -> Void)!) {
